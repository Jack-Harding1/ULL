...
def run_experiment_one():
    ...
    test_file = open("../data/MEN_dataset_natural_form_full", "r")
...
def run_experiment_oneb():
    word_embeddings_file = open("../data/deps.words", "r")
    test_file = open("../data/MEN_dataset_natural_form_full", "r")
    return run_MEN_similarity_testb(word_embeddings_file, test_file)
...
def run_MEN_similarity_testb(word_embeddings, test_file):
    ...
    for line in test_list[1:]:
        ...
        if len(line_list) == 3:
            ...
            if word1 in word_embedding_dictionary.keys() and word2 in word_embedding_dictionary.keys():
                ...
                embeddings_score_list.append(cosine_score)
                MEN_score_list.append(float(line_list[2]))
    return(pearsonr(embeddings_score_list, MEN_score_list))
